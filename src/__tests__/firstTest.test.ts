...
const todoInput: By = By.xpath('//div/section/header/input');
// this locator will find ALL the todos
const todos: By = By.xpath('//div/section/section/ul/li/div[@class="view"]');
// this locator will find the text of a todo FROM the todo
const todoLabel: By = By.xpath(('//div/section/section/ul/li/div/label'));
// this locator will find the checkbox for the todo FROM the todo
const todoComplete: By = By.xpath('//div/section/section/ul/li/div/input[@class="toggle"]');
// this locator is for the "Clear complete" button in the corner
const clearCompletedButton: By = By.xpath('//footer/div/button');
